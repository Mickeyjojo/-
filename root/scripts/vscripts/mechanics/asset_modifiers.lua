...
function public:init(bReload)
	...
	if IsServer() then
		local tSkinNameToUnitName = {}
		for sSkinName, tAssetModifiers in pairs(KeyValues.AssetModifiersKv) do
		...
		CustomNetTables:SetTableValue("common", "skin_name_to_unit_name", tSkinNameToUnitName)
		CustomNetTables:SetTableValue("common", "hero_id", KeyValues.HeroIDKv)
		-- DeepPrintTable(tSkinNameToUnitName)
