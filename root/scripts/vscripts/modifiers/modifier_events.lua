...
function public:OnAttackRecord(params)
	if params.attacker.tModifierEvents and params.attacker.tModifierEvents[MODIFIER_EVENT_ON_ATTACK_RECORD] then
		local tModifiers = params.attacker.tModifierEvents[MODIFIER_EVENT_ON_ATTACK_RECORD]
		for i = #tModifiers, 1, -1 do
			local hModifier = tModifiers[i]
...
function public:OnAttackStart(params)
	if params.attacker.tModifierEvents and params.attacker.tModifierEvents[MODIFIER_EVENT_ON_ATTACK_START] then
		local tModifiers = params.attacker.tModifierEvents[MODIFIER_EVENT_ON_ATTACK_START]
		for i = #tModifiers, 1, -1 do
			local hModifier = tModifiers[i]
...
function public:OnAttack(params)
	if params.attacker.tModifierEvents and params.attacker.tModifierEvents[MODIFIER_EVENT_ON_ATTACK] then
		local tModifiers = params.attacker.tModifierEvents[MODIFIER_EVENT_ON_ATTACK]
		for i = #tModifiers, 1, -1 do
			local hModifier = tModifiers[i]
...
function public:OnAttackLanded(params)
	if params.attacker.tModifierEvents and params.attacker.tModifierEvents[MODIFIER_EVENT_ON_ATTACK_LANDED] then
		local tModifiers = params.attacker.tModifierEvents[MODIFIER_EVENT_ON_ATTACK_LANDED]
		for i = #tModifiers, 1, -1 do
			local hModifier = tModifiers[i]
...
function public:OnOrder(params)
	if params.unit.tModifierEvents and params.unit.tModifierEvents[MODIFIER_EVENT_ON_ORDER] then
		local tModifiers = params.unit.tModifierEvents[MODIFIER_EVENT_ON_ORDER]
		for i = #tModifiers, 1, -1 do
			local hModifier = tModifiers[i]
...
function public:OnTakeDamage(params)
	if params.unit.tModifierEvents and params.unit.tModifierEvents[MODIFIER_EVENT_ON_TAKEDAMAGE] then
		local tModifiers = params.unit.tModifierEvents[MODIFIER_EVENT_ON_TAKEDAMAGE]
		for i = #tModifiers, 1, -1 do
			local hModifier = tModifiers[i]
...
function public:OnAttackRecordDestroy(params)
	if params.attacker.tModifierEvents and params.attacker.tModifierEvents[MODIFIER_EVENT_ON_ATTACK_RECORD_DESTROY] then
		local tModifiers = params.attacker.tModifierEvents[MODIFIER_EVENT_ON_ATTACK_RECORD_DESTROY]
		for i = #tModifiers, 1, -1 do
			local hModifier = tModifiers[i]
