LinkLuaModifier("modifier_medusa_3", "abilities/sr/medusa/medusa_3.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_medusa_3_debuff", "abilities/sr/medusa/medusa_3.lua", LUA_MODIFIER_MOTION_NONE)
--Abilities
...
function modifier_medusa_3:OnTakeDamage(params)
	if params.attacker == self:GetParent() and UnitFilter(params.unit, DOTA_UNIT_TARGET_TEAM_ENEMY, DOTA_UNIT_TARGET_BASIC+DOTA_UNIT_TARGET_HERO, DOTA_UNIT_TARGET_FLAG_MAGIC_IMMUNE_ENEMIES, params.attacker:GetTeamNumber()) == UF_SUCCESS then
