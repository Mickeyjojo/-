LinkLuaModifier("modifier_juggernaut_3", "abilities/sr/juggernaut/juggernaut_3.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_juggernaut_3_thinker", "abilities/sr/juggernaut/juggernaut_3.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_juggernaut_3_delay_remove", "abilities/sr/juggernaut/juggernaut_3.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_juggernaut_3_ignore_armor", "abilities/sr/juggernaut/juggernaut_3.lua", LUA_MODIFIER_MOTION_NONE)
