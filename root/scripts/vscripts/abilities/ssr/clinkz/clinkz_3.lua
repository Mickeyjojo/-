LinkLuaModifier("modifier_clinkz_3", "abilities/ssr/clinkz/clinkz_3.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_clinkz_3_summon", "abilities/ssr/clinkz/clinkz_3.lua", LUA_MODIFIER_MOTION_NONE)
...
function clinkz_3:ScepterSummon(iCount)
	...
	for i = 1, iCount, 1 do
		...
		local army_clinkz_2 = hArmy:FindAbilityByName("clinkz_2")
