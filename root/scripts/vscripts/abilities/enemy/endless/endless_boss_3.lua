LinkLuaModifier("modifier_endless_boss_3", "abilities/enemy/endless/endless_boss_3.lua", LUA_MODIFIER_MOTION_NONE)
--Abilities
if endless_boss_3 == nil then
	endless_boss_3 = class({})
end
function endless_boss_3:GetIntrinsicModifierName()
	return "modifier_endless_boss_3"
end
---------------------------------------------------------------------
--Modifiers
if modifier_endless_boss_3 == nil then
	modifier_endless_boss_3 = class({})
end
function modifier_endless_boss_3:IsHidden()
	return true
end
function modifier_endless_boss_3:IsDebuff()
	return false
end
function modifier_endless_boss_3:IsPurgable()
	return false
end
function modifier_endless_boss_3:IsPurgeException()
	return false
end
function modifier_endless_boss_3:IsStunDebuff()
	return false
end
function modifier_endless_boss_3:AllowIllusionDuplicate()
	return false
end
function modifier_endless_boss_3:OnCreated(params)
	self.health_percent = self:GetAbilitySpecialValueFor("health_percent")
	AddModifierEvents(MODIFIER_EVENT_ON_DEATH, self)
end
function modifier_endless_boss_3:OnRefresh(params)
	self.health_percent = self:GetAbilitySpecialValueFor("health_percent")
end
function modifier_endless_boss_3:OnDestroy()
	RemoveModifierEvents(MODIFIER_EVENT_ON_DEATH, self)
end
function modifier_endless_boss_3:DeclareFunctions()
	return {
		-- MODIFIER_EVENT_ON_DEATH,
	}
end
function modifier_endless_boss_3:OnDeath(params)
