LinkLuaModifier("modifier_t13_maim", "abilities/tower/t13_maim.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_t13_maim_debuff", "abilities/tower/t13_maim.lua", LUA_MODIFIER_MOTION_NONE)
--Abilities
