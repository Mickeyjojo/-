if combination_t34_hell_fusion == nil then
	combination_t34_hell_fusion = class({}, nil, BaseRestrictionAbility)
end
function combination_t34_hell_fusion:CastFilterResultTarget(target)
	...
	if target:GetUnitName() ~= "t25" then
...
function combination_t34_hell_fusion:GetCustomCastErrorTarget(target)
	return self.error or ""
end

function combination_t34_hell_fusion:OnSpellStart()
	local caster = self:GetCaster()
