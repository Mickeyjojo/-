LinkLuaModifier("modifier_combination_t01_ferocious_aura", "abilities/tower/combinations/combination_t01_ferocious_aura.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_combination_t01_ferocious_aura_effect", "abilities/tower/combinations/combination_t01_ferocious_aura.lua", LUA_MODIFIER_MOTION_NONE)
--Abilities
