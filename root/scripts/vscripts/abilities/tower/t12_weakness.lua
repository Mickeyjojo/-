LinkLuaModifier("modifier_t12_weakness", "abilities/tower/t12_weakness.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_t12_weakness_effect", "abilities/tower/t12_weakness.lua", LUA_MODIFIER_MOTION_NONE)
--作祟
--Abilities
...
function modifier_t12_weakness:OnIntervalThink()
	if IsServer() then
	end
end
function modifier_t12_weakness:OnDestroy()
	if IsServer() then
	end
end 
